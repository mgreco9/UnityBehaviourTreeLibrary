...
{
    public class FocusRectangleSelector : MouseManipulator
    {
        private readonly RectangleSelect m_Rectangle;
        GraphElement clickedElement;
        bool m_Active;

        public FocusRectangleSelector()
        {
        ...
        private void OnMouseUp(MouseUpEvent e)
        {
            ...
            if (selectionRect.height * selectionRect.width < 10)
            {
                if (clickedElement != null)
                {
        ...
        private class RectangleSelect : ImmediateModeElement
        {
            ...
            {
                Handles.color = col;
                Handles.DrawDottedLine(p1, p2, segmentsLength);
            }
        }
    }
}
